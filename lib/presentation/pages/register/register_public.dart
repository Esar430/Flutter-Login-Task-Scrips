              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    key: const Key(registerScrollViewKey),
                    child: Padding(
                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                key: const Key(registerEmailTextFieldKey),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                key: const Key(registerPWDTextFieldKey),
                                style: const TextStyle(
                                    color: Colors.white, fontFamily: 'UniNeue'),
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  top: 40, left: 20.0, right: 40),
                              child: TextFormField(
                                key: const Key(registerConfirmPWDTextFieldKey),
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontFamily: 'UniNeue',
                                    fontSize: 18),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                  key: const Key(registerSubmitBtnKey),
                                  ...
                                  onPressed: () {
                                    ...
                                    if(validateForm()){
                                     Prefs.setString(Prefs.myMail, emailController.text);
                                     Prefs.setString(Prefs.myPassword, pwdController.text);

                    ...
                    child: Padding(
                      ...
                      child: BlocConsumer<AuthBloc, AuthState>(
                        listener: (context, state) {
                          ...
                          }else if(state is AuthGrantedSharePrefs){
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 20.0, right: 40),
                                  child: TextFormField(
                                    key: const Key(loginEmailTextFieldKey),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 20.0, right: 40),
                                  child: TextFormField(
                                    key: const Key(loginPWDTextFieldKey),
                                    style: const TextStyle(
                                        color: Colors.white,
                                        fontFamily: 'UniNeue',
                                        fontSize: 18),
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      key: const Key(loginSubmitBtnKey),
                          ...
                          FocusScope.of(context).requestFocus(FocusNode()),
                                ...
                                Center(
                                  child: GestureDetector(
                                    key: const Key(loginFGTPWDTextKey),
                                    onTap: () {
                                      Navigator.of(context)
                                          .pushNamed('/forgot-password/update-password');
                                    },
                                    child: const Text(
